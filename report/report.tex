...
\end{figure}
As seen in \figurename{\ref{fig:votes_distribution}}, the distribution is very uneven in favor of reviews with no votes. This is relevant when evaluating our predictive power. To get another perspective on review votes we plot the data into a heatmap in relation to ratings.
\begin{figure}[h]
	\centering
...
\end{figure}
This shows that there is a drastic change after 11 upvotes.
\begin{figure}[h]
	\centering
...
\end{figure}
Here we see a pattern that reviewers tend to give 5-star ratings.
\begin{figure}[h]
	\centering
