...
%------------------------------------------------
\section{Methods}
We have made use of the agile and iterative research approach proposed in Nunamaker et al., to continuously gain feedback on the activities involved in our process.
